...
When a touch event was done on the right-down corner, the mouse pointer moved to the center of the screen. Some configuration scripts had to be modified for the ? graphical display server.
...
\subsubsection{Webpage to send messages}
